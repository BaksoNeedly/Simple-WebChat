...
class HttpRouterRegistrar:
    ...
    def register_routes(self) -> None:
        # Main
        self._router.get("/", lambda request: AssetController.serve_response("login.html"))
        ...
        # IMG
        self._router.get("/img/user_icon.jpg", lambda request: AssetController.serve_response("user_icon.jpg"))
        ...
        self._router.get("/js/auth/login/Login.js", lambda request: AssetController.serve_response("Login.js", "frontend/js/auth/login/"))
        self._router.get("/js/auth/login/LoginUI.js", lambda request: AssetController.serve_response("LoginUI.js", "frontend/js/auth/login/"))
        self._router.get("/js/packets/LoginPacket.js", lambda request: AssetController.serve_response("LoginPacket.js", "frontend/js/packets/"))
        ...
        self._router.get("/js/chat/ui/chat/ChatFooterUI.js", lambda request: AssetController.serve_response("ChatFooterUI.js", "frontend/js/chat/ui/chat"))
        self._router.get("/js/chat/NewChatUI.js", lambda request: AssetController.serve_response("NewChatUI.js", "frontend/js/chat/"))
