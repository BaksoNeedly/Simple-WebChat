...
class HttpRouterRegistrar:
    ...
    def register_routes(self) -> None:
        ...
        self._router.get("/css/chat_2.css", lambda request, client_socket: AssetController.serve_response("chat_2.css"))

        # Images
        self._router.get("/img/user_icon.jpg", lambda request, client_socket: AssetController.serve_response("user_icon.jpg", "frontend/img/"))
        self._router.get("/img/logo.jpg", lambda request, client_socket: AssetController.serve_response("logo.jpg", "frontend/img/"))
        ...
        self._router.get("/js/packets/http/LoadUserPacket.js", lambda request, client_socket: AssetController.serve_response("LoadUserPacket.js", "frontend/js/packets/http/"))
        self._router.get("/js/packets/http/StartChatPacket.js", lambda request, client_socket: AssetController.serve_response("StartChatPacket.js", "frontend/js/packets/http/"))
        ...
        # Chat Components (UI, Message, Room, User)
        self._router.get("/js/chat/ui/chat/ChatUI.js", lambda request, client_socket: AssetController.serve_response("ChatUI.js", "frontend/js/chat/ui/chat/"))
        ...
        self._router.get("/js/chat/ui/chat/ChatHeaderUI.js", lambda request, client_socket: AssetController.serve_response("ChatHeaderUI.js", "frontend/js/chat/ui/chat/"))
        ...
        # Utils
        self._router.get("/js/utils/ColorUtils.js", lambda request, client_socket: AssetController.serve_response("ColorUtils.js", "frontend/js/utils/"))
